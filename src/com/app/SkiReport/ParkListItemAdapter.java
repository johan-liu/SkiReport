...
public class ParkListItemAdapter extends BaseAdapter {
	Context			mContext = null;
	ParkListActivity mActivity = null;
    private LayoutInflater mInflater;
    
    private ArrayList<STParkInfo> m_parkInfos;

    public ParkListItemAdapter(ParkListActivity activity, Context context) {
    	mContext = context;
    	mActivity = activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (parkInfo != null)
        {
            ...
            if (parkInfo.iconstate == -1 && parkInfo.weatherStr.equals(""))
                strTemp = "";
