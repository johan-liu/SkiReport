...
public class ParkSearchItemAdapter extends BaseAdapter {
	Context			mContext = null;
	ParkSearchActivity mActivity = null;
    private LayoutInflater mInflater;

    private ArrayList<STParkInfo> m_parkInfos = new ArrayList<STParkInfo>();

    public ParkSearchItemAdapter(ParkSearchActivity activity, Context context) {
    	mContext = context;
    	mActivity = activity;
